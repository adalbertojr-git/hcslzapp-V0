...
part 'send.email.controller.g.dart';

class SendEmailController = SendEmailControllerBase
    with _$SendEmailController;

abstract class SendEmailControllerBase with Store {
  var formController;
