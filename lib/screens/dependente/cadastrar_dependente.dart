...
class CadastrarDependente extends StatefulWidget {
  final Dependente dependente;

  CadastrarDependente(this.dependente);

  @override
  _CadastrarDependenteState createState() => _CadastrarDependenteState();
}

class _CadastrarDependenteState extends State<CadastrarDependente> {
