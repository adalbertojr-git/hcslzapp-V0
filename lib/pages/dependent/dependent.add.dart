...
class _DependentAddState extends State<DependentAdd> {
  DependentController _controller;
  List<DropdownMenuItem<String>> _dropDownBloodTypes;
  bool _isAssociated = false;

  @override
  void initState() {
    _controller = Provider.of<DependentController>(context, listen: false);
                    ...
                    Container(
                      ...
                      child: Switch(
                        value: (widget.dependent != null
                            ? (widget.dependent.isAssociated == 'S'
                                ? true
                                : false)
                            : false),
                        onChanged: (value) {
  ...
  _add(BuildContext context) {
    ...
    final String isAssociated = (_isAssociated == true ? 'S' : 'N');
    if (name != '' && email != '' && phone != '') {
      final dependent = Dependent(
